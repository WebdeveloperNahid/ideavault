...
export default function HomePage() {
  ...
  return (
    <main>
      {/* ── Banner image gula cng kora hoiyase ── */}
      <section
        className="relative text-white py-24 px-6 text-center bg-cover bg-center transition-all duration-1000 ease-in-out"
        style={{
          backgroundImage: `linear-gradient(rgba(25, 153, 245, 0.2), rgba(25, 153, 245, 0.2)), url(${slides[current].image})`,
        }}
      >
        <p className="text-[#fafafafd] text-sm tracking-widest uppercase mb-2">
          {slides[current].sub}
        </p>
        ...
        <Link
          href="/ideas"
          className="inline-block bg-[#56afee] text-blue-00 font-semibold px-6 py-3 rounded-lg hover:bg-white hover:text-[#56afee] transition-colors duration-200"
        >
          Explore Ideas →
        </Link>
